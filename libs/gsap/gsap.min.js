!(function (t, e) {
		...
		Vt =
			...
			(Xt.totalTime = function totalTime(t, e) {
				...
				if (r && r.smoothChildTiming && this._ts) {
					for (
						Ha(this, t), !r._dp || r.parent || Ia(r, this);
						r && r.parent;
			...
			(Xt.repeatDelay = function repeatDelay(t) {
				if (arguments.length) {
					var e = this._time;
					return (
						(this._rDelay = t), Ra(this), e ? this.time(e) : this
					);
				}
				return this._rDelay;
			}),
			...
			(Xt.invalidate = function invalidate() {
				return (
					(this._initted = this._act = 0), (this._zTime = -q), this
				);
			}),
	...
	var Qt = (function (i) {
		function Timeline(t, e) {
			...
			return (
				...
				t.paused && r.paused(!0),
				t.scrollTrigger &&
					Ka(_assertThisInitialized(r), t.scrollTrigger),
				r
			);
		}
		...
		return (
			...
			(e.render = function render(t, e, r) {
				...
				if (
					...
					if (
						...
						return (
							(this._start = f), Ga(this), this.render(t, e, r)
						);
			...
			(e.previousLabel = function previousLabel(t) {
				return (
					void 0 === t && (t = this._time), qb(this, wt(this, t), 1)
				);
			}),
			...
			(Timeline.updateRoot = function updateRoot(t) {
				if (
					(B._ts && (ma(B, Fa(t, B)), (f = zt.frame)), zt.frame >= _t)
				) {
					_t += V.autoSleep || 120;
					var e = B._first;
					if (
	...
	function $b(t, e, i, n, a, o) {
		...
		if (
			...
			((i._pt = h =
				new me(i._pt, a, t, 0, 1, u.render, u, 0, u.priority)),
			i !== c)
		)
			for (
				...
				if (
					...
					for (o = 0; o < h; o++)
						((u = ta(r, Ht)).stagger = 0),
							...
							(u.delay =
								(+Gt(m, _assertThisInitialized(a), o, f, C) ||
									0) - a._delay),
							!T &&
								1 === h &&
								u.delay &&
			...
			return (
				...
				m !== vr &&
					...
					r.svg &&
						...
						(r.forceCSS =
							t.setAttribute('transform', '') || !fe(Md(t, hr))),
				...
				(r.zOrigin = parseFloat(X.split(' ')[2]) || 0) &&
					(F[lr] = br(X)),
